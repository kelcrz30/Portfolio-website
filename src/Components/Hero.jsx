...
function Hero() {
    ...
    return (
        <section className="px-3 md:px-14 mt-15 mb-17 md:mb-20 flex items-center relative">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-baseline">
                    ...
                    <div className="text-right relative z-10">
                        ...
                        <button
                            ...
                            className="relative z-20 text-black bg-transparent border-gray-400 border rounded-full py-4 px-4 hover:bg-orange-400 hover:text-black transition-all duration-300 mt-4 hover:scale-105 transform cursor-pointer inline-block"
