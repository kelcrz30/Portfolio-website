...
const toggleMenu = () => setIsOpen(!isOpen);
    return (
        <>
         <header className="text-white py-6 px-14 border-b border-white/10 relative z-40 bg-black">
            <div className="flex items-center justify-between">
                <h2>Portfolio</h2>

                <nav className="hidden md:flex items-center space-x-8">
                <a href="#" className="font-medium hover:text-gray-300 transition-colors">About</a>
                <a href="#" className="font-medium hover:text-gray-300 transition-colors">Work</a>
                <a href="#" className="font-medium hover:text-gray-300 transition-colors">Contact</a>
                </nav>
        ...
        <div className={`fixed inset-0 z-40 bg-black md:hidden transition-all duration-500 ease-in-out ${
            isOpen
            ? 'opacity-100 visible'
            : 'opacity-0 invisible'
        }`}>
